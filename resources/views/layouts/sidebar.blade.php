<aside id="layout-menu" class="layout-menu menu-vertical bg-menu-theme shadow-lg">
    <div class="app-brand text-center rounded mt-2">
        <a href="/" class="app-brand-link d-flex flex-column align-items-center text-decoration-none">
            <img src="{{ asset('img/df.png') }}" alt="Logo" class="mb-2" style="height: 80px;">
            <h5 class="fw-bold text-primary mb-0">{{ config('app.name', 'My Project') }}</h5>
        </a>
    </div>
            ...
            <ul class="menu-sub list-unstyled ps-4 mt-1 hidden peer-checked:block">
                <li class="menu-item mb-1">
                    <a href="{{ route('members.index') }}"
                        class="menu-link d-flex align-items-center px-2 py-1 rounded small text-decoration-none {{ request()->routeIs('members.index') ? 'active-sub' : '' }}">
                ...
                <li class="menu-item mb-1">
                    <a href="{{ route('visitors.index') }}"
                        class="menu-link d-flex align-items-center px-2 py-1 rounded small text-decoration-none {{ request()->routeIs('visitors.index') ? 'active-sub' : '' }}">
                        ...
                        @foreach ($project->children as $menuItem)
                            <li class="menu-item mb-1">
                                <a href="{{ url($menuItem->uri) }}"
                                    class="menu-link d-flex align-items-center px-2 py-1 rounded small text-decoration-none {{ Request::is(trim($menuItem->uri, '/')) ? 'active-sub' : '' }}">
