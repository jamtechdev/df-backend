...
trait ApiResponseTrait
{
     ...
     * @return JsonResponse
     */
    public function errorHandler(int $code = 500, string $message = '',int $customCode=0): JsonResponse
    {
        $error = [
            'version' => 'v1',
            'message' => $message,
            'code' => $code,
            'platform_error_code' => $customCode
        ];
     ...
     * @return JsonResponse
     */
    public function successHandler($data, int $code = 200, string $message = ''): JsonResponse
    {
        $response = [
            'data' => $data,
            'version' => 'v1',
    ...
    public function okHandler(int $code = 200, string $message = ''): JsonResponse
    {
        $error = [
            'version' => 'v1',
            'message' => $message,
